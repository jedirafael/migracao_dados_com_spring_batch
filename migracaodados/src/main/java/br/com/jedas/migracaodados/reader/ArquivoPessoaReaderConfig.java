...
public class ArquivoPessoaReaderConfig {
    ...
    public FlatFileItemReader<Pessoa> arquivoPessoaReader() {
        return new FlatFileItemReaderBuilder<Pessoa>()
                ...
                //.targetType(Pessoa.class)Utilizado quando os campos são exatamente oq vem do arquivo
                .fieldSetMapper(fielSetMapper())
                .build();
    }

    private FieldSetMapper<Pessoa> fielSetMapper() {
